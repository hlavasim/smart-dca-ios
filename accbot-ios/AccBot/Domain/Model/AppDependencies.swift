...
final class AppDependencies: ObservableObject {
    ...
    let manualSpendStore: ManualSpendStore
    let fioCategoryStore: FioCategoryStore
    ...
    init() {
        ...
        self.manualSpendStore = manualSpendStore
        self.fioCategoryStore = fioCategoryStore
